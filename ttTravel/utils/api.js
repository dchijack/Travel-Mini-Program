...
const indexAdsense = function(data) {
	return API.get('/wp-json/mp/v1/advert/toutiao?type=index', data);
}
...
const listAdsense = function(data) {
	return API.get('/wp-json/mp/v1/advert/toutiao?type=list', data);
}
...
const detailAdsense = function(data) {
	return API.get('/wp-json/mp/v1/advert/toutiao?type=detail', data);
}
...
const pageAdsense = function(data) {
	return API.get('/wp-json/mp/v1/advert/toutiao?type=page', data);
}
